...
namespace SPK
{
	...
	EmitterAttacher::EmitterData::EmitterData(unsigned int nbParticles,Group* emittingGroup) :
	...
	void EmitterAttacher::EmitterData::setEmitter(unsigned int index,const Ref<Emitter>& emitter)
	{
