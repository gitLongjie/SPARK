...
namespace SPK
{
	...
	Ref<Group> System::createGroup(unsigned int capacity)
	{
		if (capacity == 0)
		{
			SPK_LOG_ERROR("System::createGroup(unsigned int) - The capacity of a Group cannot be 0, NULL is returned");
			return SPK_NULL_REF;
		}
	...
	unsigned int System::getNbParticles() const
	{
